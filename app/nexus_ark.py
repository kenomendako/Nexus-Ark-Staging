...
import traceback
import pandas as pd
import config_manager, room_manager, alarm_manager, ui_handlers, constants, onboarding_manager, timers, discord_manager
                    ...
                    with gr.TabItem("🐦 Twitter (X)"):
                        ...
                        with gr.Tabs(elem_id="twitter_main_tabs") as twitter_main_tabs:
                            ...
                            with gr.TabItem("⚙️ 設定"):
                                ...
                                gr.Markdown("---")
                                twitter_enabled_checkbox = gr.Checkbox(label="Twitter連携機能を有効にする", value=True)
                                gr.Markdown("---")
