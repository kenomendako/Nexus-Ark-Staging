const CACHE_NAME = "nexus-ark-lite-v86";
const ASSETS = [
  "/lite",
  "/lite/",
  "/lite/manifest.webmanifest",
  "/lite/static/styles.css?v=86",
  "/lite/static/app.js?v=86",
  "/lite/static/pairing-handoff.js?v=86",
  "/lite/static/lite-continuity-state.js?v=86",
  "/lite/static/travel-adapter.js?v=86",
  "/lite/icon.png",
